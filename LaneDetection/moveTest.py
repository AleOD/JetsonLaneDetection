...
def region_of_interest(canny):
   ...
   erosion = cv2.erode(masked_image,kernel,iterations = 3)
   dilation = cv2.dilate(masked_image,kernel,iterations = 3)
   erosion2 = cv2.erode(masked_image,kernel,iterations = 1)
